    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          ...
          "50%": { boxShadow: "0 0 40px hsl(var(--primary) / 0.6), 0 0 80px hsl(var(--accent) / 0.2)" },
        },
        "slide-up": {
      ...
      animation: {
        ...
        "accordion-up": "accordion-up 0.35s cubic-bezier(0.7, 0, 0.84, 0)",
        "fade-in": "fade-in 0.6s ease-out forwards",
        "glow-pulse": "glow-pulse 2s ease-in-out infinite",
        "slide-up": "slide-up 0.6s ease-out",
        "hero-entrance": "hero-entrance 1s cubic-bezier(0.16, 1, 0.3, 1) forwards",
