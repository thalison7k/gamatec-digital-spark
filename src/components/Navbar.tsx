          ...
          <>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="end"
                sideOffset={8}
                className="w-56 z-[9999] border-2 border-primary/30 bg-slate-950/95 backdrop-blur-xl shadow-2xl shadow-primary/20 p-1.5"
              >
                ...
                <DropdownMenuSub>
                  ...
                  <DropdownMenuSubContent
                    sideOffset={8}
                    className="z-[9999] border-2 border-primary/30 bg-slate-950/95 backdrop-blur-xl shadow-2xl shadow-primary/20 p-1.5"
                  >
                    <DropdownMenuItem
                      onClick={(e) => { e.preventDefault(); toggleTheme(); }}
                      className="cursor-pointer gap-2 rounded-md text-slate-200 focus:bg-primary/20 focus:text-white data-[highlighted]:bg-primary/20 data-[highlighted]:text-white transition-colors"
